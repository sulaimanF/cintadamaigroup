        ...
        <div class="row g-4">
            <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                ...
                <div class="service-item p-0">
                    <a href="{{ route('pages.testdrive') }}" class="btn btn-primary center rounded py-2 px-4">Kontak Sekarang</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="service-item p-0">
                    <a href="{{ route('pages.bookservice') }}" class="btn btn-primary center rounded py-2 px-4">Kontak Sekarang</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                ...
                <div class="service-item p-0">
                    <a href="{{ route('pages.bodypaint') }}" class="btn btn-primary center rounded py-2 px-4">Kontak Sekarang</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="service-item p-0">
                    <a href="{{ route('pages.sparepart') }}" class="btn btn-primary center rounded py-2 px-4">Kontak Sekarang</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                ...
                <div class="service-item p-0">
                    <a href="{{ route('pages.customercare') }}" class="btn btn-primary center rounded py-2 px-4">Kontak Sekarang</a>
                </div>
            </div>
        </div>
    </div>
