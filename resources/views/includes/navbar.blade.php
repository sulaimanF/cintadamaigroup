    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a href="{{ route('pages.index') }}" class="navbar-brand p-0">
                <img src="{{asset('template_fe/img/logocd.png')}}" alt="Logo">
                ...
                <div class="navbar-nav mx-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="https://suzukicintadamai.co.id/" class="dropdown-item" target="_blank">Suzuki</a>
                            <a href="https://hyundaimandiri.com/" class="dropdown-item" target="_blank">Hyundai</a>
                            <a href="https://honda-eiyu.com/" class="dropdown-item" target="_blank">Honda</a>
